...
public class BasketService(IBasketRepository repository, ILogger<BasketService> logger) : Basket.BasketBase
{
    ...
    public override async Task<CustomerBasketResponse> UpdateBasket(CustomerBasketRequest request,
        ServerCallContext context)
    {
        ...
        if (response is null)
        {
            throw new RpcException(new Status(StatusCode.NotFound,
                $"Basket with buyer id {request.BuyerId} does not exist"));
        }

        return MapToCustomerBasketResponse(response);
    }

    public override async Task<CheckoutCustomerBasketResponse> CheckoutBasket(CheckoutCustomerBasketRequest request,
        ServerCallContext context)
    {
    ...
    public override async Task<DeleteCustomerBasketResponse> DeleteBasket(DeleteCustomerBasketRequest request,
        ServerCallContext context)
    {
